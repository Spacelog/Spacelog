...
urlpatterns = patterns('',
    ...
    url(r'^page/(?P<transcript>[\d\w]+)/(?P<start>' + tspatt + ')/$', PageView.as_view(), name="view_page"),
    ...
    url(r'^(?P<transcript>[\d\w]+)/(?P<start>' + tspatt + ')/$', RangeView.as_view(), name="view_range"),
    url(r'^(?P<transcript>[\d\w]+)/(?P<start>' + tspatt + ')/(?P<end>' + tspatt + ')/$', RangeView.as_view(), name="view_range"),
